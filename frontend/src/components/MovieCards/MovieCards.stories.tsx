...
// Cards per variant
const defaultCards: MovieCardData[] = [
  { id: 1, title: 'Inception', thumbnail: movieCardImg },
  { id: 2, title: 'Inception', thumbnail: movieCardImg },
];
...
const top10Cards: MovieCardData[] = [
  ...
  { id: 19, title: 'Hit #6', thumbnail: movieCardImg, rank: 6 },
];
